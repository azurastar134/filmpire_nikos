...
import {Box, Button, CircularProgress, Grid, makeStyles, Typography} from '@mui/material';
    ...
    <>
      <Grid container spacing={3}>
        ...
        <Grid item lg={7} xl={8} style={{display: 'flex', justifyContent: 'center', flexDirection: 'column'}}>
          ...
          <Typography variant="body1" align="justify" paragraph>{data?.biography || 'Sorry not biography yet'}</Typography>
